 ...
 *
 * Skipped when nunusDisableVideoAutoplay is false (popup). document_start; MutationObserver singleton.
 */
(function() {
  ...
  ext.storage.local.get({ [DISABLE_VIDEO_AUTOPLAY_KEY]: true }, r => {
    if (r[DISABLE_VIDEO_AUTOPLAY_KEY] === false) return;
